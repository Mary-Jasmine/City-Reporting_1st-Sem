...
<body class="dashboard-body">
    ...
    <div class="container">
        ...
        <div class="data-grid">
            <div class="data-card"style="max-height: 1400px; overflow-y: auto;">
        <h3>Incidents by Barangay</h3>
        <div>
            <?php 
                $counts = array_column($barangay_data, 'count');
                
                $max_count = empty($counts) ? 1 : max($counts);
                ...
                if (empty($barangay_data)) {
                    echo '<p style="text-align: center; color: #6b7280; padding: 20px;">No incident data available for the selected period.</p>';
                } else {
